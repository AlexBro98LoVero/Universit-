...
\begin{teorema}{Teorema di Fermat}{}
    Siano $a,b \in \mathbb{R}$, $a<b$, $f:(a,b) \to \mathbb{R}$, $x_0 \in (a,b)$. Se $x_0$ è un punto di estremo relativo per $f$, e $f$ è derivabile in $x_0$, allora $f'(x_0) = 0$.
\end{teorema}
\begin{proof}
...
\begin{align*}
    h'(c) &= \dfrac{\big[f(M)-g(M)\big] - \big[f(0)-g(0)\big]}{M-0} \\
