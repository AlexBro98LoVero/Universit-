...
\addcontentsline{toc}{section}{Teorema del binomio di Newton}
...
\addcontentsline{toc}{section}{Teorema dell'Irrazionalità di $\sqrt{2}$}
...
\addcontentsline{toc}{section}{Definizione di Insieme Limitato}
...
\addcontentsline{toc}{section}{Definizione di Massimo e Minimo}
\noindent
...
\addcontentsline{toc}{section}{Teorema dell'unicità dei Massimi e Minimi}
...
\begin{definizione}{Estremi Superiore e Inferiore}{}
 \addcontentsline{toc}{section}{Definizione Estremi Superiori e Inferiore}
...
\addcontentsline{toc}{section}{Relazione Massimi/Minimi e Estremi}
    \begin{itemize}
...
\addcontentsline{toc}{section}{Caratterizzazione degli Estremi}
...
\addcontentsline{toc}{section}{Completezza di $\mathbb{R}$ \textit{I°} forma}
...
\addcontentsline{toc}{section}{Completezza di $\mathbb{R}$ \textit{II°} forma}
...
\addcontentsline{toc}{section}{Definizione di Intorno}
...
\addcontentsline{toc}{section}{Teorema di Intersezione degli Intorni}
\noindent
...
\addcontentsline{toc}{section}{Teorema di Separazione degli introni}
\noindent
...
\end{teorema}
    ...
    \addcontentsline{toc}{section}{Definizione di punto di Accumulazione}
...
\addcontentsline{toc}{section}{Definizione di punto di Accumulazione Destro/Sinistro}
...
\addcontentsline{toc}{section}{Definizione di Limite}
...
\addcontentsline{toc}{section}{Teorema di Unicità del Limite}
...
\begin{esercizio}{}{}
\addcontentsline{toc}{section}{Esercizi Dimostrazione Limite}
    \begin{equation*}
...
\addcontentsline{toc}{section}{Definizione di Limite Destro e Sinistro}
...
\addcontentsline{toc}{section}{Relazione Limite con limite Destro e Sinistro}
...
\addcontentsline{toc}{section}{Limite del Valore Assoluto di una Funzione}
...
\addcontentsline{toc}{section}{Limite del Valore Assoluto di una Funzione (caso $l=0$)}
...
\addcontentsline{toc}{section}{Teorema della Permanenza del Segno}
...
\addcontentsline{toc}{section}{Limiti e Relazioni d'Ordine I}
\begin{teorema}{limiti e relazioni d'ordine I}
...
\begin{teorema}{limiti e relazioni d'ordine II}{}

\addcontentsline{toc}{section}{Limiti e Relazioni d'Ordine II}
    Siano $\varnothing \ne A \subseteq \mathbb{R}$, $f,g:A\to\mathbb{R}$, $x_0$ punto di accumulazione in $A$ e $l_1=\lim_{x\to x_0} f(x)$ e   $l_2=\lim_{x\to x_0} g(x)$
...
\addcontentsline{toc}{section}{Teorema dei due Carabinieri}
...
\addcontentsline{toc}{section}{Algebra dei Limiti Finiti}
...
\addcontentsline{toc}{section}{Algebra dei Limiti Infiniti (Forme Determinate)}
...
\addcontentsline{toc}{section}{Esercizi sull'Algebra dei Limiti Infiniti}
\begin{esercizio}{}{}
    \[
...
\addcontentsline{toc}{section}{Forme Indeterminate}
...
\addcontentsline{toc}{section}{Primi Esercizi sulle Forme Indeterminate}
...
\addcontentsline{toc}{section}{Teorema del Cambio di Variabile}
...
\addcontentsline{toc}{section}{Limite di funzioni Monotone caso Finito}
...
\addcontentsline{toc}{section}{Limite di funzioni Monotone caso Infinito}
...
\addcontentsline{toc}{section}{Limiti Notevoli}
...
\addcontentsline{toc}{section}{Definizione di Funzioni Asintotiche}
...
\addcontentsline{toc}{section}{Teorema delle Proprità delle Funzioni Asintotiche}
